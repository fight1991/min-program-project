...
Page({
  ...
  onLoad: function(options) {
    that = this
    that.data.activityInfo.activityId = options.scene
  ...
  confirm: function(e) {
    ...
    console.log('***************************')
    that.data.obj.province = that.data.multiArray[0][that.data.multiIndex[0]]
    that.data.obj.city = that.data.multiArray[1][that.data.multiIndex[1]]
    console.log(that.data.obj)
    wx.showLoading({
      title: '提交中...',
      icon: "none"
    })
    app.platformApi.activity("/activity/saveActivityActor", {
      "activityId": that.data.activityInfo.activityId,
      "addressCity": that.data.obj.city,
      "addressDetail": that.data.obj.address,
      "addressProvince": that.data.obj.province,
      "code": that.data.obj.code,
      "corpName": that.data.obj.companyName,
      "mobile": that.data.obj.mobile,
      "position": that.data.obj.position,
      "userName": that.data.obj.name
    }, function(data) {
      if (data.code == "0000") {
        that.regist()
      } else {
  ...
  regist: function() {
    app.platformApi.commonApi("/login/regist", {
      ...
      "mobileCode": this.data.obj.mobile,
      "password": "",
      "sysId": "004"
    }, function(data) {
      wx.hideLoading()
  ...
  addCorpInfo: function () {
    app.platformApi.commonApi("/corp/addSelectCorpBindUser", {
      corpId: 0,
      corpName: this.data.obj.companyName,
      defaulCorp: "",
      registerClient: "2",
      registerSource: "004"
    }, function () {
