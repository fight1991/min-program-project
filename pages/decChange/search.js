...
Page({
  ...
  search: function(e) {
    ...
    if (this.data.from == "home") {
      wx.redirectTo({
        url: 'decChange?year=' + this.data.date + '&company=' + this.data.searchModel.company + '&i_e_flag=' + this.data.searchModel.i_e_flag,
      })
    } else {
