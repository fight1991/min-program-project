...
Page({
  ...
  onLoad: function(options) {
    ...
    if (typeof(options.inner_no) != "undefined") {
  ...
  search: function(e) {
    ...
    if (this.data.from == "home") {
      wx.redirectTo({
        url: 'act?inner_no=' + this.data.searchModel.inner_no + '&bill_no=' + this.data.searchModel.bill_no + '&begin_date=' + this.data.date1 + '&end_date=' + this.data.date2 + '&status=' + this.data.searchModel.status + '&i_e_flag=' + this.data.i_e_flag,
      })
    } else {
  ...
  reset: function() {
    this.data.searchModel.inner_no = ""
    this.data.searchModel.bill_no = ""
    this.data.searchModel.traf_mode = ""
    this.data.searchModel.begin_date = ""
    this.data.searchModel.end_date = ""
    this.data.searchModel.status = ""
    var searchModel = this.data.searchModel
