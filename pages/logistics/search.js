...
Page({
  ...
  search: function(e) {
    ...
    if (this.data.from == "home") {
      wx.redirectTo({
        url: 'logistics?entry_id=' + this.data.searchModel.entry_id + '&bill_no=' + this.data.searchModel.bill_no + '&inner_no=' + this.data.searchModel.inner_no + '&begin_date=' + this.data.date1 + '&end_date=' + this.data.date2 +
