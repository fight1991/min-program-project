...
Page({
  ...
  onLoad: function (options) {
    ...
    if (typeof (options.district_code) != "undefined") {
      this.data.searchModel["district_code"] = options.district_code
      this.data.searchModel["district_name"] = options.district_name
    }
    //显示上一次查询数据
